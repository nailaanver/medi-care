            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                  Our comprehensive solution covers all aspects of clinic management, from patient booking to inventory
                  control.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                },
                {
                  ...
                  description: "Track medicine stock, set alerts, and manage suppliers.",
                  icon: (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                    ...
                    >
                      ...
                      <path d="M18 10H8" />
                      <path d="M14 18h-3" />
                      <path d="M4 10v4a2 2 0 0 0 2 2h2" />
                    </svg>
                  ),
                },
                {
                  title: "Analytics & Reports",
                  description: "Generate insights on clinic performance, revenue, and patient trends.",
                  icon: (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
